...
class MainFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        root = if (sectionNumber == 0) inflater.inflate(R.layout.fragment_page_one, container, false)
        else layoutInflater.inflate(R.layout.fragment_page_two, container, false)
        return root
    }
